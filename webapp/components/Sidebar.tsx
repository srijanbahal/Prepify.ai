...
export default function Sidebar({ user }: SidebarProps) {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-border/40 bg-[#0A0B0F] backdrop-blur-xl">
      {/* Logo */}
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-all ${
                  isActive
                    ? "bg-gradient-to-r from-blue-500/10 to-purple-500/10 text-blue-400 shadow-lg shadow-blue-500/5"
      ...
      <div className="p-4 border-t border-border/40">
        <div className="rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-600/10 p-4 border border-blue-500/20">
          ...
          <button className="w-full rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 px-4 py-2 text-xs font-medium text-white hover:shadow-lg hover:shadow-purple-500/25 transition-all">
            Upgrade Now
          </button>
        </div>
      </div>
